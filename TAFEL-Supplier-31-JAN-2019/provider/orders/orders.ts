...
export class OrdersProvider {
	...
	callRefundServiceManager(dinnerId, itemPrice, fivedigitId, orderId): Observable < any > {
		var input = {};
		input = {
			"dinerId": dinnerId,
			"amount": itemPrice,
	...
	callRefundServicFullOrdereManager(dinnerId, itemPrice, fivedigitId, orderId): Observable < any > {
		var input = {};
		input = {
			"dinerId": dinnerId,
			"amount": itemPrice,
