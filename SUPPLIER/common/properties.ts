...
if(env === 'PROD'){
    ...
    // supplier_item_refund = 'https://otw4guy5i3.execute-api.ap-south-1.amazonaws.com/v1';
    TAFEL_API_KEY = 'zp9hwKSeWL34X641QUjnpVMJvP0GB0N7COQdGyX7';        
}
else if(env === 'DEV'){
