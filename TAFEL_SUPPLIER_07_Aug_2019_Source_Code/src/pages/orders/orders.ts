...
console.log("this.getOutletDetailsVal", this.getOutletDetailsVal.name);
    ...
    ionViewDidEnter() {
        ...
        this.clearIntervals = setInterval(function () { console.log(this.segmentName); this.segmentChange(this.segmentName, 1) }.bind(this), 95000);
    }
    ...
    acceptFullOrder(fullorder) {
        ...
        this.oprovider.updateStatusChange(url, "INPROGRESS", 0, "",fullorder.id).subscribe(resp => {
            ...
            if (rejectedItemsArray.length > 0) {
                ...
                this.oprovider.callRefundAmountServiceOrderLet(ordeLetLevelurl).subscribe(resp => { debugger
