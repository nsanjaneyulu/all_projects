...
<center><h1 class="banner">Add Question Form</h1></center>

<div class="content">
    <div id="signupbox">
       <div id="signuptab">
        <ul>
          <li id="signupcurrent"><a href=" ">Add Question</a></li>
        </ul>
      </div>
	  <c:set var="added" value="${param.add}" />

<font color="#663399" size="+1">
<c:if test="${added eq false}" ><c:out value="enter all fields and select a answer" /></c:if><c:if test="${param.add eq true}" ><c:out value="question added successfully.." />
  </c:if>
  </font>


    <a href="QuestionManagement.jsp"  ><left><b>Add Question in other category</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <right><a href="examhome.jsp" ><b>Exam Home</b></a></right>
    
</font>
      <div id="signupwrap">
      		<form id="signupform" autocomplete="off" method="post" action="./addquestion" name="addquestion">
	  		  <table>
	  		 

			  <tr>
	  			<td class="label"><label id="myquestion" for="question">Question</label></td>
	  			<td class="field"><textarea name= "question" id="question" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>

			  <tr>
	  			<td class="label"><label id="myoption1" for="option1">option1</label></td>
	  			<td class="field"><textarea name= "option1" id="option1" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>

			  <tr>
	  			<td class="label"><label id="myoption2" for="option2">option2</label></td>
	  			<td class="field"><textarea name= "option2" id="option2" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>

			  <tr>
	  			<td class="label"><label id="myoption3" for="option3">option3</label></td>
	  			<td class="field"><textarea name= "option3" id="option3" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>

			  <tr>
	  			<td class="label"><label id="myoption4" for="question">option4</label></td>
	  			<td class="field"><textarea name= "option4" id="option4" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>

			  <tr>
	  			<td class="label"><label id="myexplanation" for="explanation">Explanation</label></td>
	  			<td class="field"><textarea name= "explanation" id="explanation" rows="6" cols="70"></textarea></td>
	  			<td class="status"></td>
	  		  </tr>
